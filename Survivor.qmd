...
The results of our logistic regression expressed in odds ratios for a one unit increase in the predictor are tabulated in @tbl-regression-output-odds-ratios. Logit estimates are presented in the [Appendix](#appendix) in @tbl-regression-output. Odds ratio estimates were converted from logit estimates by exponentiating the logit estimate. 
